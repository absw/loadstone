...
use super::autogenerated::{self, devices, memory_map::{EXTERNAL_BANKS, MCU_BANKS}, pin_configuration::{self, *}};
...
impl Default for BootManager<flash::McuFlash, ExternalFlash, Serial, ImageReader> {
    fn default() -> Self { Self::new() }
}

impl BootManager<flash::McuFlash, ExternalFlash, Serial, ImageReader> {
    pub fn new() -> Self {
