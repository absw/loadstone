...
use super::autogenerated::devices::{self, UpdateSignalType};
use super::autogenerated::BOOT_TIME_METRICS_ENABLED;
use super::autogenerated::RECOVERY_ENABLED;

impl Default for Bootloader<ExternalFlash, flash::McuFlash, Serial, SysTick, UpdateSignalType> {
    fn default() -> Self { Self::new() }
}

impl Bootloader<ExternalFlash, flash::McuFlash, Serial, SysTick, UpdateSignalType> {
    pub fn new() -> Self {
        ...
        let update_signal = devices::construct_update_signal();
