...
use super::update_signal::FixedUpdateSignal;
use crate::devices::update_signal::UpdatePlan;

impl Default for Bootloader<ExternalFlash, flash::McuFlash, Serial, SysTick, ImageReader, FixedUpdateSignal> {
    fn default() -> Self { Self::new() }
}

impl Bootloader<ExternalFlash, flash::McuFlash, Serial, SysTick, ImageReader, FixedUpdateSignal> {
    pub fn new() -> Self {
        ...
        let update_signal = if UDPATE_SIGNAL_ENABLED {
            Some(FixedUpdateSignal::new(UpdatePlan::None))
        } else {
            None
        };
