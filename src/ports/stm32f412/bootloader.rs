...
// TODO: Use Actual update signal.
use blue_hal::hal::null::NullUpdateSignal;

impl Default for Bootloader<ExternalFlash, flash::McuFlash, Serial, SysTick, NullUpdateSignal> {
    fn default() -> Self { Self::new() }
}

impl Bootloader<ExternalFlash, flash::McuFlash, Serial, SysTick, NullUpdateSignal> {
    pub fn new() -> Self {
