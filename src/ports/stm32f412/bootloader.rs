...
use blue_hal::{drivers::{micron::n25q128a_flash, stm32f4::{flash, rcc::Clocks, serial, systick::SysTick}}, hal::time, stm32pac};
use super::autogenerated::pin_configuration::{self, *};
use super::autogenerated::memory_map::EXTERNAL_BANKS;
use super::autogenerated::memory_map::MCU_BANKS;
use super::autogenerated::devices;
use super::autogenerated::BOOT_TIME_METRICS_ENABLED;
use super::autogenerated::RECOVERY_ENABLED;
use super::autogenerated::UPDATE_SIGNAL_ENABLED;

use blue_hal::drivers::stm32f4::update_signal::FixedUpdateSignal;

impl Default for Bootloader<ExternalFlash, flash::McuFlash, Serial, SysTick, FixedUpdateSignal> {
    fn default() -> Self { Self::new() }
}

impl Bootloader<ExternalFlash, flash::McuFlash, Serial, SysTick, FixedUpdateSignal> {
    pub fn new() -> Self {
        ...
        let update_signal = if UPDATE_SIGNAL_ENABLED {
            Some(FixedUpdateSignal::new(false))
        } else {
            None
        };
