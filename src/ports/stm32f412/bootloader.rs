...
use super::autogenerated::{self, BOOT_TIME_METRICS_ENABLED, RECOVERY_ENABLED, devices, memory_map::{EXTERNAL_BANKS, MCU_BANKS}, pin_configuration::{self, *}};
...
impl Default for Bootloader<ExternalFlash, flash::McuFlash, Serial, SysTick, ImageReader> {
    fn default() -> Self { Self::new() }
}

impl Bootloader<ExternalFlash, flash::McuFlash, Serial, SysTick, ImageReader> {
    pub fn new() -> Self {
