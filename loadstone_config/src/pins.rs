...
pub fn serial_tx(port: &Port) -> PinIterator {
    match port {
        ...
        Port::Stm32F446 => Box::new(IntoIterator::into_iter([
            PeripheralPin::new(Cow::from("USART2"), Cow::from("a"), 2, 7),
            PeripheralPin::new(Cow::from("USART1"), Cow::from("a"), 9, 7),
            PeripheralPin::new(Cow::from("UART4"), Cow::from("a"), 0, 8),
            PeripheralPin::new(Cow::from("USART1"), Cow::from("b"), 6, 7),
            PeripheralPin::new(Cow::from("USART3"), Cow::from("b"), 10, 7),
            PeripheralPin::new(Cow::from("USART3"), Cow::from("c"), 10, 7),
            PeripheralPin::new(Cow::from("UART4"), Cow::from("c"), 10, 8),
            PeripheralPin::new(Cow::from("UART5"), Cow::from("c"), 12, 8),
            PeripheralPin::new(Cow::from("USART2"), Cow::from("d"), 5, 7),
            PeripheralPin::new(Cow::from("USART3"), Cow::from("d"), 8, 7),
            PeripheralPin::new(Cow::from("UART5"), Cow::from("e"), 8, 8),
            PeripheralPin::new(Cow::from("USART6"), Cow::from("g"), 14, 8),
        ])),
...
pub fn serial_rx(port: &Port) -> PinIterator {
    match port {
        ...
        Port::Stm32F446 => Box::new(IntoIterator::into_iter([
            PeripheralPin::new(Cow::from("USART2"), Cow::from("a"), 3, 7),
            PeripheralPin::new(Cow::from("USART1"), Cow::from("a"), 10, 7),
            PeripheralPin::new(Cow::from("UART4"), Cow::from("a"), 1, 8),
            PeripheralPin::new(Cow::from("USART1"), Cow::from("b"), 7, 7),
            PeripheralPin::new(Cow::from("USART3"), Cow::from("b"), 11, 7),
            PeripheralPin::new(Cow::from("USART3"), Cow::from("c"), 5, 7),
            PeripheralPin::new(Cow::from("USART3"), Cow::from("c"), 11, 7),
            PeripheralPin::new(Cow::from("UART4"), Cow::from("c"), 11, 8),
            PeripheralPin::new(Cow::from("USART2"), Cow::from("d"), 6, 7),
            PeripheralPin::new(Cow::from("USART3"), Cow::from("d"), 9, 7),
            PeripheralPin::new(Cow::from("UART5"), Cow::from("d"), 2, 8),
            PeripheralPin::new(Cow::from("UART5"), Cow::from("e"), 7, 8),
            PeripheralPin::new(Cow::from("USART6"), Cow::from("g"), 9, 8),
        ])),
        Port::Wgm160P => Box::new(None.into_iter()),
        Port::Max32631 => Box::new(None.into_iter()),
